...
#pragma warning(pop)
   ...
   switch (key) 
   {
      case Key::Left: code = sf::Keyboard::Left; break;
      case Key::Right:code = sf::Keyboard::Right; break;
      case Key::Up:code = sf::Keyboard::Up; break;
      case Key::Down:code = sf::Keyboard::Down; break;
      case Key::Space:code = sf::Keyboard::Space; break;
      case Key::Escape:code = sf::Keyboard::Escape; break;
   }
...
void Screen::DrawText(int ox, int oy, Color color, const std::string& text)
{
    DrawText(ox, oy, color.r, color.g, color.b, color.a, text);
}

void Screen::DrawText(int ox, int oy, unsigned char r, unsigned char g, unsigned char b, unsigned char a, const std::string& text)
{
